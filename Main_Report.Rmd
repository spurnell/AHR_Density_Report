...
```{r}
#loading data 
historical_data <- read.csv("C:/Users/SPENC/Downloads/R_Feeder_ MAIN_Historical - Main Database (1).csv", na.strings = c(""," ", "NA"))
...
```{r}
Full_Data <- read.csv("C:/Users/SPENC/Downloads/Cost of doing business - Full Data (2).csv")
...
matrix_plot <- read.csv("C:/Users/SPENC/Downloads/Cost of doing business - matrix.csv", check.names = FALSE)
...
cost_exploration <- read.csv("C:/Users/SPENC/Downloads/Cost of doing business - Full Data (1).csv")

cost_exploration <- as.data.frame(cost_exploration)
...
```{r, warning=F}
cost_of_living <- read.csv("C:/Users/SPENC/Downloads/advisorsmith_cost_of_living_index - advisorsmith_cost_of_living_index.csv")
